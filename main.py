...
st.image("2023-7-23--10-37-28-128_RnI Logo PNG.png", use_container_width=True)  # Replace with actual image URL
...
ask_question = st.button("Ask AI Research Assistant")
...
if ask_question:
    ...
    if uploaded_file and user_query:
        ...
        st.chat_message("AI Research Assistant").write(response)
